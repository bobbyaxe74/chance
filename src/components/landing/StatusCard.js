...
export default function StatusCard({ color, icon, title, children }) {
    return (
        <div className="w-full md:w-4/12 px-4 flex justify-center mb-3 text-center">
            <Card className="bg-gradient-to-r from-purple-800 to-green-500 hover:from-pink-500 hover:to-green-500 py-2 px-4 rounded focus:ring transform transition hover:scale-105 duration-300 ease-in-out" >
                <CardBody>
                    <div
