            ...
            <CardBody>
                <div className="overflow-x-auto">
                    <table className="items-center w-full bg-transparent border-collapse">
                        ...
                        <tbody>
                            <tr>
                                <th className="border-b border-gray-200 align-middle font-light text-white text-sm whitespace-nowrap px-2 py-4 text-left">
                                    Argon Design System
                                </th>
                                <th className="border-b border-gray-200 align-middle font-light text-white text-sm whitespace-nowrap px-2 py-4 text-left">
                                    $2,500 USD
                            ...
                            <tr>
                                ...
                                <th className="border-b border-gray-200 align-middle font-light text-white text-sm whitespace-nowrap px-2 py-4 text-left">
                                    <i className="fas fa-circle fa-sm text-blue-gray-200 mr-2"></i>{' '}
                                    completed
                                </th>
                                <th className="border-b border-gray-200 align-middle font-light text-sm text-white whitespace-nowrap px-2 py-4 text-left">
                                    <div className="flex">
                                        {/* <div className="w-10 h-10 rounded-full border-2 border-white">
                                            <Image
                                                src={Team1}
